    ...
    <section class="inner-page">
        <div class="container room">
            ...
            <div class="container" id="main">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-sm-4 mb-4 mt-4">
                        <label for="formFileMultiple" class="form-label text-center"><spring:message code="UpladPicture"/>
...
<%--                    tutaj dodaja sie obrazki--%>
        ...
        <div class="mx-auto" style="width: 200px;">
            <a href="/apartment/details/${apartment.id}" class="btn btn-danger">ZAKOŃCZ EDYTOR POKOI</a>
        </div>
